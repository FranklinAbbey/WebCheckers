 ...
 * </p>
 *
 * @authors <a href='mailto:bdbvse@rit.edu'>Bryan Basham</a>
 *         Summer DiStefano
 *         Frank Abbey
 *         Raisa Hossain
 *         Stephen Bosonac
...
public class WebServer {
  ...
  public PlayerLobby playerLobby = new PlayerLobby();
  ...
  public void initialize() {
    ...
    //Player Sign In (POST a username to '/signin')
    post(SIGNIN_URL, new PostSignInRoute(templateEngine));

    //Player Sign Out (POST a username to '/signout')
    ...
    //POST "/resignGame"
    post(RESIGN_URL, new PostResignGameRoute(gameCenter));

    //POST "/exitGame"
    post(EXIT_URL, new PostExitGameRoute(gameCenter));
